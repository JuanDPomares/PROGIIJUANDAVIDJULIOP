...
class Login(tk.Tk):
    ...
    def __init__(self):
        ...
        self.logo = utl.leer_imagen("C:\\Users\\Biblioteca\\Downloads\\Clase9\\LoginApp\\imagenes\\logo.png", (300, 100))
        self.user = utl.leer_imagen("C:\\Users\\Biblioteca\\Downloads\\Clase9\\LoginApp\\imagenes\\login.png", (48, 48))
    ...
    def validar(self):
        if self.cusuario.get() == "admin" and self.cclave.get() == "1234":
                self.destroy()
                from Formulario.PAdmin import PAdmin
                PAdmin().mainloop()
        else:
